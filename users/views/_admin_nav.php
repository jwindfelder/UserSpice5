...
if (!empty($_GET['action'])) {
    ...
    if ($action == 'newDropdown') {
        ...
        */
        $fields = ['menu_title'=>$menu_title, 'parent'=>'-1', 'dropdown'=>'1', 'logged_in'=>'1', 'display_order'=>'99999', 'label'=>'New Dropdown', 'link'=>'#', 'icon_class'=>''];
        ...
        */
        $fields = ['menu_title'=>$menu_title, 'parent'=>'-1', 'dropdown'=>'0', 'logged_in'=>'1', 'display_order'=>'99999', 'label'=>'New Item', 'link'=>'#', 'icon_class'=>''];
        $db->insert('menus', $fields);
        $lastId = $db->lastId();
