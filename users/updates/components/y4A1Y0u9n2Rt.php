...
$find = $db->query('SELECT id,label FROM menus WHERE label = ?', ['Home'])->results();
foreach ($find as $f) {
...
$find = $db->query('SELECT id,label FROM menus WHERE label = ?', ['Log In'])->results();
foreach ($find as $f) {
...
$find = $db->query('SELECT id,label FROM menus WHERE label = ?', ['Register'])->results();
foreach ($find as $f) {
...
$find = $db->query('SELECT id,label FROM menus WHERE label = ?', ['Help'])->results();
foreach ($find as $f) {
...
$find = $db->query('SELECT id,label FROM menus WHERE label = ?', ['Account'])->results();
foreach ($find as $f) {
...
$find = $db->query('SELECT id,label FROM menus WHERE label = ?', ['Admin Dashboard'])->results();
foreach ($find as $f) {
...
$find = $db->query('SELECT id,label FROM menus WHERE label = ?', ['Permissions Manager'])->results();
foreach ($find as $f) {
...
$find = $db->query('SELECT id,label FROM menus WHERE label = ?', ['Page Management'])->results();
foreach ($find as $f) {
...
$find = $db->query('SELECT id,label FROM menus WHERE label = ?', ['System Logs'])->results();
foreach ($find as $f) {
...
$find = $db->query('SELECT id,label FROM menus WHERE label = ?', ['Messages Manager'])->results();
foreach ($find as $f) {
...
$find = $db->query('SELECT id,label FROM menus WHERE label = ?', ['Forgot Password'])->results();
foreach ($find as $f) {
...
$find = $db->query('SELECT id,label FROM menus WHERE label = ?', ['Logout'])->results();
foreach ($find as $f) {
...
$find = $db->query('SELECT id,label FROM menus WHERE label = ?', ['Resend Activation Email'])->results();
foreach ($find as $f) {
