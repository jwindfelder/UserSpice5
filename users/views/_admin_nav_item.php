  ...
  <form name='edit_menu_item' action='admin.php?view=nav_item&id=<?=$menuId?>&action=edit' method='post'>
    ...
    <div class="form-group">
      ...
      <select class="form-control" name="parent">
        <option value="-1" <?php if ($item->parent == -1) {
    echo 'selected="selected"';
} ?> >No Parent</option>
        <?php
        foreach ($dropdowns as $dropdown) {
            ?>
          <option value="<?=$dropdown->id?>" <?php if ($item->parent == $dropdown->id) {
                echo 'selected="selected"';
    ...
    <div class="form-group">
      ...
      <select class="form-control" name="dropdown">
        <option value="1" <?php if ($item->dropdown == 1) {
            echo 'selected="selected"';
        } ?> >Yes</option>
        <option value="0" <?php if ($item->dropdown == 0) {
            echo 'selected="selected"';
        } ?> >No</option>
      </select>
    </div>
    ...
    <div class="form-group">
      ...
      <select class="form-control" name="logged_in">
        <option value="1" <?php if ($item->logged_in == 1) {
            echo 'selected="selected"';
        } ?> >Yes</option>
        <option value="0" <?php if ($item->logged_in == 0) {
            echo 'selected="selected"';
        } ?> >No</option>
      </select>
    </div>
