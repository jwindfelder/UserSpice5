                ...
                <form class="form" action="" method="post">
					<div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                <?php
                                    ...
                                    // View
																		...
																		<?php
                                                                        echo '<option disabled selected="selected">--Select Timezone--</option>';
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                <input required class="form-control" type="text" name="dbh" value="<?php if (!empty($_POST['dbh'])) {
                                        echo $_POST['dbh'];
                                    } ?>" required>
                              </div>
                          </div>
                          <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                  <input required class="form-control" type="text" name="dbu" value="<?php if (!empty($_POST['dbu'])) {
                                        echo $_POST['dbu'];
                                    } ?>" required>
                              </div>
                          </div>
                          <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                <input class="form-control" type="text" name="dbp" value="<?php if (!empty($_POST['dbp'])) {
                                        echo $_POST['dbp'];
                                    } ?>">
                              </div>
                          </div>
                          <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                  <input class="form-control" type="text" name="dbn" value="<?php if (!empty($_POST['dbn'])) {
                                        echo $_POST['dbn'];
                                    } ?>" required>
                              </div>
                          </div>
